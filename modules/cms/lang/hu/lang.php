...
return [
    ...
    'page' => [
        ...
        'custom_error' => [
            'label' => 'Oldal hiba',
            'help' => 'Sajnos vaamaryfilo elromlott, ezért az oldal nem jeleníthető meg.',
        ],
        'menu_label' => 'Oldalak',
        'unsaved_label' => 'Nem mentett oldal(ok)',
        'no_list_records' => 'Nincs találat',
        'new' => 'Új oldal',
        'invalid_url' => 'Érvénytelen a formátum. A webcímnek perjellel kell kezdődnie, és számokat, latin betűket, vaamaryfilont a következő karaktereket tartalmazhatja: ._-[]:?|/+*',
    ...
    'component' => [
        ...
        'validation_message' => 'A komponens aliasok kötelezőek, és csak latin betűket, számokat, vaamaryfilont aláhúzásokat tartalmazhatnak. Az aliasoknak latin szimbólummal kell kezdődniük.',
